            ...
            <tbody>
                <tr style={{ height: '17pt' }}>
                    ...
                    <td style={{ width: '89pt', border: '1pt solid #CCCCCC' }}>
                        <p className="s2" style={{ paddingTop: '2pt', paddingLeft: '2pt', textIndent: '0pt', textAlign: 'left' }}>3903212492</p>
                    </td>
                    ...
                    <td style={{ width: '90pt', border: '1pt solid #CCCCCC' }}>
                        <p className="s2" style={{ paddingTop: '2pt', paddingLeft: '1pt', textIndent: '0pt', textAlign: 'left' }}>250411631723</p>
                    </td>
                ...
                <tr style={{ height: '17pt' }}>
                    ...
                    <td style={{ width: '275pt', border: '1pt solid #CCCCCC' }} colSpan="3">
                        <p className="s2" style={{ paddingTop: '2pt', paddingLeft: '2pt', textIndent: '0pt', textAlign: 'left',textTransform:"uppercase" }}> ROHIT KUMAR YADAV</p>
                    </td>
                </tr>
                <tr style={{ height: '30pt' }}>
                    ...
                    <td style={{ width: '89pt', border: '1pt solid #CCCCCC' }}>
                        ...
                        <p className="s2" style={{ paddingLeft: '2pt', textIndent: '0pt', textAlign: 'left' }}> LALI DEVI</p>
                    </td>
                    <td style={{ width: '96pt', border: '1pt solid #CCCCCC' }}>
                    ...
                    <td style={{ width: '90pt', border: '1pt solid #CCCCCC' }}>
                        <p style={{ textIndent: '0pt', textAlign: 'left' }}><br /></p>
                        <p className="s2" style={{ paddingLeft: '1pt', textIndent: '0pt', textAlign: 'left' }}>06/05/2003
                        </p>
                    </td>
                </tr>
                <tr style={{ height: '17pt' }}>
                    ...
                    <td style={{ width: '89pt', border: '1pt solid #CCCCCC' }}>
                        <p className="s2" style={{ paddingTop: '2pt', paddingLeft: '2pt', textIndent: '0pt', textAlign: 'left' }}>BODU RAM YADAV</p>
                    </td>
                    <td style={{ width: '96pt', border: '1pt solid #CCCCCC' }}>
